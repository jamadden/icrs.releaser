# -*- coding: utf-8 -*-
#
# icrs.releaser documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('.'))
rqmt = pkg_resources.require('icrs.releaser')[0]
...
#
# html_title = u'icrs.releaser v1.0'
...
htmlhelp_basename = 'ntiwebhooksdoc'
...
extlinks = {'issue': ('https://github.com/jamadden/icrs.releaser/issues/%s',
                      'issue #'),
            'pr': ('https://github.com/jamadden/icrs.releaser/pull/%s',
                   'pull request #')}
